...
　　本篇文章累计了大量评论，和我的一些解答，读者有什么问题可以先看看评论，或者搜下关键字，如果还是有问题可以给我在评论里给我留言，问题很着急的可以加我 ＱＱ：1499065178　，或者给我发邮件：[deepindo@sina.com](mailto:deepindo@sina.com) ，都可以，如果你已经搭建完成了，可以看看我的另一篇博客[HEXO进阶](http://deepindo.github.io/2016/06/HEXO_Advanced)，有讲如何能百度搜索你的博客、多台电脑使用HEXO发布博客等。我现在的博客是使用 Jekyll 搭建的，如果你想使用我现在的模板请看[Jekyll搭建个人博客](http://deepindo.github.io/2016/10/jekyll_tutorials1/) 
...
然后建立关联，我的Blog在本地/Users/deepindo/Blog，Blog是我之前建的东西也全在这里面，有：
...
翻到最下面，改成我这样子的，注意： `: 后面要有空格`
	...
	deploy:
	  type: git
	  repository: https://github.com/deepindo/deepindo.github.io.git
	  branch: master
...
　然后再浏览器中输入[http://deepindo.github.io/](http://deepindo.github.io/)就行了，我的 github 的账户叫 deepindo ,把这个改成你 github 的账户名就行了
...
转载请注明原地址，潘柏信的博客：[http://deepindo.github.io](http://deepindo.github.io) 谢谢！
